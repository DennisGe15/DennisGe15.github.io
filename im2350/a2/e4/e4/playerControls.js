...
/*
I want to immediately mute the audio and unmute it again
...
muteButtton.addEventListener('click', muteUnmute);
...
function exitFullScreen() {
  if(videoElement.exitFullScreen){
    videoElement.full = false;
    openfullScreenButton.style.backgroundImage = "url('./icons/fullScreen.svg')";
    } else {
    videoElement.full = true;
    closefullScreenButton.style.backgroundImage = "url('./icons/fullScreen.svg')";
  }
}
